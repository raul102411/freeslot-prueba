...
import BlacklistTourSteps from '@/components/tour/company/BlacklistTourSteps';
...
const Blacklist = () => {
  ...
  const steps: Step[] = BlacklistTourSteps;
    ...
    >
        ...
        >
          <DialogContent className="max-w-sm">
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <Button
                className="bg-red-600 text-white tour-delete-btn"
      ...
      {loading ? (
        ...
        >
          ...
          <Button
            className="bg-red-600 hover:bg-red-700 text-white tour-add-btn"
            onClick={openNew}
          >
