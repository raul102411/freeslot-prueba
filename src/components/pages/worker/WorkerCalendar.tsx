...
const WorkerCalendar = () => {
  ...
  console.log('[WorkerCalendar] render, reloadKey=', reloadKey);
  ...
  const diasNoLaborables = useDiasNoLaborablesPorUsuario(idUsuario);
  ...
  // Construye businessHours a partir de horariosUsuario
